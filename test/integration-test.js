...
describe('integration', function () {
  describe('testbot', function () {
    ...
    var assertHelp = function (options, lambdaContext, lambdaCallback) {
      ...
      if (slackbot.root !== slackbot.help) {
        descriptions.unshift(': Test command root');
      }
    ...
    describe('with root command', function () {
      beforeEach(function () {
        slackbot.setRootCommand('Test command root', function (options, cb) {
          cb(null, this.ephemeralResponse('Root response'));
        });
      });

      it('routes to the root command by default', function () {
        var event = {
          body: {
            token: 'token',
            text: ''
