...
describe('finding the right commands', function () {
  ...
  beforeEach(function () {
    ...
    slackbot.addCommand('root function', function () {})
  });
  ...
  it('finds the root command when no other command matches', function () {
    var foundCommand = slackbot.findCommand('arg1 arg2');
    expect(foundCommand).to.deep.equal({ commandName: 'root', args: ['arg1', 'arg2'] });
  });
